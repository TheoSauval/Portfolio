const t = {
  en: {
    ...
    heroS1:       '/ WEB DEVELOPMENT',
    heroS2:       '/ VISUAL DESIGN',
    heroS3:       '/ F1 ENTHUSIAST',
    heroLocation: 'BASED — IN — LILLE',
    heroBio:      '5TH YEAR COMPUTER SCIENCE STUDENT',

    // About section (index)
    aboutH2:      'Welcome to the portfolio of <em>Theo Sauval</em>',
    aboutP:       'visual designer, <em>athlete</em> and <span class="hover-trigger" data-video="assets/videoF1.mp4">F1</span> fanatic',
    aboutH4:      '5th year computer science student <span class="hover-trigger" data-image="assets/ynovcampus_logo.jpg">@ Ynov Campus — Based in Lille</span>',
    aboutDesc:    'Passionate about web development and visual content creation, currently apprenticing at Lacier as a full-stack web developer.',
    bar1:         '[NICE TO MEET YOU]',
    bar2:         '[SCROLL DOWN]',
    ...
    aboutHeroTitle:  'Creative<br><em>developer</em><br>& designer',
    aboutHeroIntro:  '5th year computer science student, currently apprenticing at Lacier as a full-stack web developer. Passionate about building fast, expressive, and purposeful digital experiences.',
    aboutEduLabel:   '(01) — Education',
    aboutEduDesc:    'Bachelor in Computer Science, specialisation Web & Mobile development. 2022 — 2026.',
    aboutExpLabel:   '(02) — Experience',
    aboutExpTitle:   'Lacier<br>Apprentice',
    aboutExpDesc:    'Full-stack web developer. Design and development of production platforms serving thousands of clients.',
    aboutIntLabel:   '(03) — Interests',
    aboutIntTitle:   'Beyond<br>the screen',
    aboutIntDesc:    'Formula 1 fanatic, visual design enthusiast. Always looking for the intersection of speed, precision and aesthetics.',
    ...
    ctaEmail:   'Email',
    ctaSubject: 'Subject',
    ctaSelectPlaceholder: 'Select a subject…',
    ctaMsg:     'Message',
    ctaOpt1:    'Website creation',
    ctaOpt2:    'UI / Visual design',
    ctaOpt3:    'GSAP animation',
    ctaOpt4:    'Other',
    ctaSubmit:  'Send →',
    ...
    // Footer
    footerHL:  'AVAILABLE FOR<br>NEW PROJECTS',
    fHome:     'Home',
    fProjects: 'Projects',
    fServices: 'Services',
    fAbout:    'About',
    ...
    csMetaRole:    'Role',
    csMetaClient:  'Client',
    csLabel1:      '(01) — Overview',
    csLabel2:      '(02) — Challenge',
    csLabel3:      '(03) — Key features',
    csLabel4:      '(04) — Tech stack',
    csBrief:       'The brief',
    csSolving:     'What needed solving',
    csSeeLive:     'See it<br>live',
    csVisit:       'Visit the site →',
    csBack:        '← Back to projects',
    csRoleDatabase:   'Database',
    csRoleDeployment: 'Deployment',
  ...
  fr: {
    // Hero (index)
    heroTitle:    'DEVELOPPEUR CREATIF',
    heroS1:       '/ DÉVELOPPEMENT WEB',
    heroS2:       '/ DESIGN VISUEL',
    heroS3:       '/ PASSIONNÉ DE F1',
    heroLocation: 'BASÉ — À — LILLE',
    heroBio:      'ÉTUDIANT EN INFORMATIQUE — 5ÈME ANNÉE',

    // About section (index)
    aboutH2:   'Bienvenue sur le portfolio de <em>Theo Sauval</em>',
    aboutP:    'designer visuel, <em>athlète</em> et passionné de <span class="hover-trigger" data-video="assets/videoF1.mp4">F1</span>',
    aboutH4:   'Étudiant en informatique 5ème année <span class="hover-trigger" data-image="assets/ynovcampus_logo.jpg">@ Ynov Campus — Basé à Lille</span>',
    aboutDesc: 'Passionné par le développement web et la création de contenu visuel, actuellement en alternance chez Lacier en tant que développeur full-stack.',
    bar1:      '[RAVI DE TE RENCONTRER]',
    bar2:      '[DÉFILER]',
    ...
    aboutHeroTitle:  'Développeur<br><em>créatif</em><br>& designer',
    aboutHeroIntro:  "Étudiant en informatique 5ème année, actuellement en alternance chez Lacier en tant que développeur full-stack. Passionné par la création d'expériences digitales rapides, expressives et intentionnelles.",
    aboutEduLabel:   '(01) — Formation',
    aboutEduDesc:    'Bachelor en Informatique, spécialisation Développement Web & Mobile. 2022 — 2026.',
    aboutExpLabel:   '(02) — Expérience',
    aboutExpTitle:   'Lacier<br>Alternant',
    aboutExpDesc:    "Développeur web full-stack. Conception et développement de plateformes en production servant des milliers de clients.",
    aboutIntLabel:   '(03) — Intérêts',
    aboutIntTitle:   "Au-delà<br>de l'écran",
    aboutIntDesc:    "Passionné de Formule 1 et de design visuel. Toujours à la recherche de l'intersection entre vitesse, précision et esthétique.",
    ...
    ctaEmail:   'Email',
    ctaSubject: 'Sujet',
    ctaSelectPlaceholder: 'Sélectionne un sujet…',
    ctaMsg:     'Message',
    ctaOpt1:    'Création de site',
    ctaOpt2:    'UI / Design visuel',
    ctaOpt3:    'Animation GSAP',
    ctaOpt4:    'Autre',
    ctaSubmit:  'Envoyer →',
    ...
    // Footer
    footerHL:  'DISPONIBLE POUR<br>DE NOUVEAUX PROJETS',
    fHome:     'Accueil',
    fProjects: 'Projets',
    fServices: 'Services',
    fAbout:    'A propos',
    ...
    csMetaRole:    'Rôle',
    csMetaClient:  'Client',
    csLabel1:      '(01) — Vue d\'ensemble',
    csLabel2:      '(02) — Défi',
    csLabel3:      '(03) — Fonctionnalités clés',
    csLabel4:      '(04) — Stack technique',
    csBrief:       'Le contexte',
    csSolving:     'Ce qui devait être résolu',
    csSeeLive:     'Voir en<br>ligne',
    csVisit:       'Visiter le site →',
    csBack:        '← Retour aux projets',
    csRoleDatabase:   'Base de données',
    csRoleDeployment: 'Déploiement',
...
function applyLang(lang) {
  ...
  if (titleEl) { titleEl.textContent = _.heroTitle; if (window.buildTitleLetters) window.buildTitleLetters(); }
  const services = selAll('.hero-services p');
  if (services.length) { services[0].textContent = _.heroS1; services[1].textContent = _.heroS2; services[2].textContent = _.heroS3; }
  sel('.hero-location') && (sel('.hero-location').textContent = _.heroLocation);
  sel('.hero-bio')      && (sel('.hero-bio').textContent      = _.heroBio);

  // ── About section (index) ─────────────────────────────────
  sel('.content-about h2')      && (sel('.content-about h2').innerHTML      = _.aboutH2);
  sel('.content-about > p')     && (sel('.content-about > p').innerHTML     = _.aboutP);
  sel('.texte_presentation h4') && (sel('.texte_presentation h4').innerHTML = _.aboutH4);
  sel('.texte_presentation p')  && (sel('.texte_presentation p').textContent = _.aboutDesc);
  const bars = selAll('.bottom-bar span');
  if (bars.length) { bars[0].textContent = _.bar1; bars[1].textContent = _.bar2; }
  if (window.setupHoverTriggers) window.setupHoverTriggers();

  // ── Projects section (index) ──────────────────────────────
  sel('.projects-header h2') && (sel('.projects-header h2').textContent = _.projectsH);
  const items = selAll('.project-item:not(.project-item--teaser)');
  if (items[0]) { items[0].querySelector('.project-left p').textContent = _.p1Desc; items[0].querySelector('.project-link').textContent = _.p1Link; }
  if (items[1]) { items[1].querySelector('.project-left p').textContent = _.p2Desc; items[1].querySelector('.project-link').textContent = _.p2Link; }
  sel('.project-item--teaser .project-teaser-title') && (sel('.project-item--teaser .project-teaser-title').innerHTML = _.indexProjectTeaser);

  // ── About bio section (index) ─────────────────────────────
  sel('.about-bio-title') && (sel('.about-bio-title').textContent = _.bioTitle);
  const bio = selAll('.about-bio-text p');
  if (bio.length >= 4) { bio[0].textContent = _.bio1; bio[1].textContent = _.bio2; bio[2].textContent = _.bio3; bio[3].textContent = _.bio4; }

  // ── About page (about.html) ───────────────────────────────
  sel('.about-page-label') && (sel('.about-page-label').textContent = _.aboutPageLabel);
  sel('.about-hero-title') && (sel('.about-hero-title').innerHTML   = _.aboutHeroTitle);
  sel('.about-intro')      && (sel('.about-intro').textContent      = _.aboutHeroIntro);
  const detailBlocks = selAll('.about-detail-block');
  if (detailBlocks[0]) {
    detailBlocks[0].querySelector('.about-detail-label').textContent = _.aboutEduLabel;
    detailBlocks[0].querySelector('.about-detail-text').textContent  = _.aboutEduDesc;
  }
  if (detailBlocks[1]) {
    detailBlocks[1].querySelector('.about-detail-label').textContent = _.aboutExpLabel;
    detailBlocks[1].querySelector('.about-detail-title').innerHTML   = _.aboutExpTitle;
    detailBlocks[1].querySelector('.about-detail-text').textContent  = _.aboutExpDesc;
  }
  if (detailBlocks[2]) {
    detailBlocks[2].querySelector('.about-detail-label').textContent = _.aboutIntLabel;
    detailBlocks[2].querySelector('.about-detail-title').innerHTML   = _.aboutIntTitle;
    detailBlocks[2].querySelector('.about-detail-text').textContent  = _.aboutIntDesc;
  }
  sel('.about-stack-header h2') && (sel('.about-stack-header h2').textContent = _.aboutStackTitle);

  // ── Services page (services.html) ────────────────────────
  sel('.services-page-title') && (sel('.services-page-title').innerHTML   = _.servicesPageTitle);
  sel('.services-page-intro') && (sel('.services-page-intro').textContent = _.servicesPageIntro);
  const svcItems = selAll('.service-detail-item');
  if (svcItems.length >= 4) {
    svcItems[0].querySelector('.service-detail-desc').textContent = _.s1Desc;
    svcItems[1].querySelector('.service-detail-desc').textContent = _.s2Desc;
    svcItems[2].querySelector('.service-detail-desc').textContent = _.s3Desc;
    svcItems[3].querySelector('.service-detail-desc').textContent = _.s4Desc;
  }
  sel('.services-cta h2')      && (sel('.services-cta h2').innerHTML       = _.servicesCTATitle);
  sel('.services-cta-link')    && (sel('.services-cta-link').textContent   = _.servicesCTALink);

  // ── Contact page (contact.html) ───────────────────────────
  sel('.contact-avail-text')  && (sel('.contact-avail-text').textContent  = _.contactAvailText);
  sel('.contact-hero-title')  && (sel('.contact-hero-title').innerHTML    = _.contactHeroTitle);
  sel('.contact-form-left h2') && (sel('.contact-form-left h2').innerHTML = _.contactFormTitle);
  sel('.contact-form-left p')  && (sel('.contact-form-left p').innerHTML  = _.contactFormDesc);
  const contactLabels = selAll('.contact-field label');
  if (contactLabels.length >= 5) {
    contactLabels[0].textContent = _.ctaFirst;
    contactLabels[1].textContent = _.ctaLast;
    contactLabels[2].textContent = _.ctaEmail;
    contactLabels[3].textContent = _.ctaSubject;
    contactLabels[4].textContent = _.ctaMsg;
  }
  const contactSubjectPlaceholder = sel('#subject option[disabled]');
  if (contactSubjectPlaceholder) contactSubjectPlaceholder.textContent = _.ctaSelectPlaceholder;
  const contactOpts = selAll('#subject option:not([disabled])');
  if (contactOpts.length >= 4) { contactOpts[0].textContent = _.ctaOpt1; contactOpts[1].textContent = _.ctaOpt2; contactOpts[2].textContent = _.ctaOpt3; contactOpts[3].textContent = _.ctaOpt4; }
  sel('.contact-submit') && (sel('.contact-submit').textContent = _.ctaSubmit);

  // ── Projects page (projects.html) ────────────────────────
  sel('.projects-page-title') && (sel('.projects-page-title').innerHTML  = _.projectsPageTitle);
  sel('.projects-teaser p')   && (sel('.projects-teaser p').textContent  = _.projectsTeaser);
  sel('.projects-cta-left h2') && (sel('.projects-cta-left h2').innerHTML = _.ctaTitle);
  sel('.projects-cta-left p')  && (sel('.projects-cta-left p').innerHTML  = _.ctaDesc);
  const ctaLabels = selAll('.projects-contact-field label');
  if (ctaLabels.length >= 5) {
    ctaLabels[0].textContent = _.ctaFirst;
    ctaLabels[1].textContent = _.ctaLast;
    ctaLabels[2].textContent = _.ctaEmail;
    ctaLabels[3].textContent = _.ctaSubject;
    ctaLabels[4].textContent = _.ctaMsg;
  }
  const pSubjectPlaceholder = sel('#p-subject option[disabled]');
  if (pSubjectPlaceholder) pSubjectPlaceholder.textContent = _.ctaSelectPlaceholder;
  const ctaOpts = selAll('#p-subject option:not([disabled])');
  if (ctaOpts.length >= 4) { ctaOpts[0].textContent = _.ctaOpt1; ctaOpts[1].textContent = _.ctaOpt2; ctaOpts[2].textContent = _.ctaOpt3; ctaOpts[3].textContent = _.ctaOpt4; }
  sel('.projects-contact-submit') && (sel('.projects-contact-submit').textContent = _.ctaSubmit);
  const fullItems = selAll('.project-full-item');
  if (fullItems[0]) { fullItems[0].querySelector('.project-full-desc').textContent = _.p1Desc; fullItems[0].querySelector('.project-full-link').textContent = _.projectFullLink; }
  if (fullItems[1]) { fullItems[1].querySelector('.project-full-desc').textContent = _.p2Desc; fullItems[1].querySelector('.project-full-link').textContent = _.projectFullLink; }

  // ── Footer ────────────────────────────────────────────────
  sel('.footer-headline') && (sel('.footer-headline').innerHTML = _.footerHL);
  const fLinks = selAll('.footer-nav a');
  if (fLinks.length >= 4) { fLinks[0].textContent = _.fHome; fLinks[1].textContent = _.fProjects; fLinks[2].textContent = _.fServices; fLinks[3].textContent = _.fAbout; }
  sel('.footer-socials .footer-col-label') && (sel('.footer-socials .footer-col-label').textContent = _.fSocials);

  // ── Menu ──────────────────────────────────────────────────
  const menuLinks = selAll('#sub-menu > a');
  const keys = ['mHome', 'mProjects', 'mServices', 'mAbout', 'mContact'];
  menuLinks.forEach((link, i) => { link.textContent = _[keys[i]]; });
  if (window.buildMenuLetters) window.buildMenuLetters();

  // ── Case studies (data-lang-key) ──────────────────────────
  selAll('[data-lang-key]').forEach(el => {
    const key = el.dataset.langKey;
    if (_[key] !== undefined) el.innerHTML = _[key];
  });
...
document.getElementById('lang-toggle').addEventListener('click', () => {
  ...
  gsap.timeline()
    .set(overlay, { visibility: 'visible', yPercent: 100, clipPath: 'inset(0 0 0% 0)' })
    .to(overlay, { yPercent: 0, duration: 0.65, ease: 'power4.inOut' })
    .call(() => applyLang(nextLang))
